...
const char* ssid     = "autera";
const char* password = "autera123";
         ...
         if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
           ...
           // client.println(".slider { width: 300px; }</style>");
            ...
            client.println("<p>Throttle: <span id=\"servoPos\"></span></p>");          
            client.println("<input type=\"range\" orient=\"vertical\" min=\"987\" max=\"2012\" class=\"slider\" id=\"servoSlider\" onchange=\"servo(this.value)\" value=\""+valueString+"\"/>");
            ...
            client.println("<p>Yaw: <span id=\"servoPos1\"></span></p>");          
            client.println("<input type=\"range\" min=\"987\" max=\"2012\" class=\"slider\" id=\"servoSlider1\" onchange=\"servo1(this.value)\" value=\""+valueString+"\"/>");
